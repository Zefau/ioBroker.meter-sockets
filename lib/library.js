...
class Library
{
	...
	_createNode(node, callback)
	{
		...
		this._adapter.setObject(node.node, {common: Object.assign({role: 'state', type: 'string', 'write': false}, node.common || {}, common), type: node.type === 'channel' ? 'channel' : 'state', native: node.native || {}}, callback);
	}
